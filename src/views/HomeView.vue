...
<div class="w-ful h-[25rem] bg-[url('https://cdn.pixabay.com/photo/2020/10/01/14/20/donations-keeps-me-going-5618697_960_720.jpg')] bg-center bg-cover relative shadow-2xl shadow-blue-500/30 lg:mt-16 mt-[10rem] ">
  ...
  <div v-if="loading" class="flex justify-center items-center m-20">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="200" height="200" style="shape-rendering: auto; display: block; background: #121212;" xmlns:xlink="http://www.w3.org/1999/xlink"><g><circle stroke-linecap="round" fill="none" stroke-dasharray="50.26548245743669 50.26548245743669" stroke="#71feac" stroke-width="8" r="32" cy="50" cx="50">
    ...
    <h1 class=" text-4xl font-bold  text-center m-8 ">Popular Pod<span class="bg-[#DE1A3E] rounded">casts</span> </h1>
      <div
