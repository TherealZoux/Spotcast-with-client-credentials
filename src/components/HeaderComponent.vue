<template>
  ...
  >
    <div class="flex flex-col md:flex-row items-center w-80 gap-4 lg:gap-16">
      <div
        class="flex items-center justify-between w-80 md:w-auto gap-4 text-[#FFFFFF]"
      >
      ...
      <Transition name="fade">
        <div class="flex items-center gap-8 lg:gap-9" v-if="menu">
          <router-link
            to="/dashboard"
            class="text-header-color opacity-75 line-through text-lg font-medium leading-normal"
